...
class PlayState extends MusicBeatState
{
	...
	override public function create()
	{
		...
		switch (curStage)
		{
			...
			case 'crib': new Stages();
			case 'crib2': new Stages();
			case 'crib3': new Stages();
			case 'street': new Stages();
			case 'dream': new Stages();
			case 'phlox': new Stages();
			case 'evilhospital': new Stages();
			case 'hospital': new Stages();
			case 'bathroom': new Stages();
			case 'testshitlol': new Stages();
		}
